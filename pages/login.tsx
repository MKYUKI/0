...
const LoginPage = () => {
  ...
  return (
    <>
      ...
      <div id="login-wrapper" style={{ position: "relative", width: "100vw", height: "100vh", overflow: "hidden", backgroundColor: "#000" }}>
        {/* 背景キャンバス */}
        ...
        {/* ログインボタン */}
        <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", zIndex: 10, textAlign: "center", padding: "20px", backgroundColor: "rgba(0, 0, 0, 0.5)", borderRadius: "8px" }}>
          <h1 style={{ color: "#fff", marginBottom: "20px" }}>Welcome to Cosmic Portal</h1>
          <button onClick={() => signIn("google")} style={{ backgroundColor: "#0070f3", border: "none", padding: "12px 24px", color: "#fff", fontSize: "1rem", borderRadius: "4px", cursor: "pointer", boxShadow: "0 4px 8px rgba(0,0,0,0.3)" }}>
            Sign in with Google
          </button>
        </div>
        {/* スクリプト読み込み */}
