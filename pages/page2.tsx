  ...
  return (
    <>
      <Head>
        ...
        {/* JS (e.g. /js/page2Logic.js) for special animations */}
      ...
      <main className="kaleidoMain">
        ...
        <section className="frontContent2">
          ...
          <p>
            Our system harnesses advanced multi-head attention modules (<a
              href="https://arxiv.org/abs/2005.14165" 
              target="_blank" 
              rel="noreferrer">Mixture of Experts</a>)
            to achieve fluid transformations in real time.
          </p>
          <nav>
